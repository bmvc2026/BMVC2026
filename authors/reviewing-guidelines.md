...
To contact the Programme Chairs (PCs), please send emails to: [bmvc2026pc@gmail.com](mailto:bmvc2026pc@gmail.com). 
...
<table class="table table-striped table-bordered" style="max-width: 750px;">
  <tbody>
    ...
    <tr>
      <td>Author Rebuttal Period</td>
      <td>Friday, 3 – Friday, 10 July 2026</td>
    </tr>
    <tr>
      <td>AC and Reviewer Discussion Period</td>
      <td>Friday, 10 – Friday, 17 July 2026</td>
    </tr>
    <tr>
      <td>Final Reviewer Recommendations Due</td>
      <td>Friday, 17 July 2026</td>
    </tr>
  </tbody>
</table>
</div>
NB: The above deadlines are fixed and cannot be extended.
...
Please read the [Author Guidelines]({{site.baseurl}}{% link authors/author-guidelines.md %}) carefully to familiarise yourself with all official policies the authors are expected to follow. If you believe that a paper may violate any of these policies, please get in touch with the ACs or PCs. In the meantime, proceed to review the paper, assuming no violation has taken place.
...
<ul>
    ...
    <li class="text-justify">You have been directly involved in the work and will be receiving credit in some way. If you are a member of an author's thesis committee, and the paper is about their thesis work, then you are considered to be involved.</li>
    <li class="text-justify">You suspect that others might perceive a conflict of interest in your involvement.</li>
    <li class="text-justify">You have collaborated with one of the authors in the past three years. Collaboration is usually defined as having written a paper or grant proposal together, although you should use your judgement.</li>
...
<ul>
    ...
    <li class="text-justify">Short reviews are unhelpful to authors, other reviewers, and ACs. If you have agreed to review a paper, you should take enough time to write a thoughtful and detailed review. Bullet lists with one short sentence per bullet are not a detailed review.</li>
