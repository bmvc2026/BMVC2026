...
The British Machine Vision Conference (BMVC) is one of the major international conferences on computer vision and related areas. It is organised by the British Machine Vision Association (BMVA). The 37th BMVC will be an **in-person** event from **23rd—26th November 2026** in Lancaster, UK.

Authors are invited to submit high-quality papers in image processing, computer vision, machine learning and related areas for BMVC 2026. Submitted papers will be refereed on originality, presentation, empirical results, and evaluation quality. Accepted papers will be included in the conference proceedings published by BMVA. 
 
Please note that BMVC is a single-track meeting with oral and poster presentations. The paper submission deadline is listed in the key dates below.
...
<table class="table table-striped table-bordered" style="max-width: 750px;">
  <tbody>
    ...
    <tr>
      <td><del>Review Period Begins</del></td>
    ...
    <tr>
      <td>BMVC 2026 Conference</td>
      <td>Monday, 23 – Thursday, 26 November 2026</td>
    </tr>
  </tbody>
</table>
</div>
...
-	Submission Portal: All submissions must be made through the OpenReview system: [OpenReview](https://openreview.net/group?id=bmva.org/BMVC/2026/Conference).

-	Anonymity: BMVC 2026 employs a double-blind review process. Submitted papers must not include any identifying information of the authors or their institutions. References to authors' own prior work should be anonymized.

-	Dual Submissions: Work submitted to BMVC 2026 must be original and cannot be under concurrent review for another peer-reviewed conference or journal. Posting a preprint to arXiv does not constitute a prior publication.
...
### Reviewing Process for BMVC 2026

Each paper will be reviewed by at least three reviewers. An Area Chair will provide a meta-review summarising the discussion and recommending a decision.
 
**Important Note on Community Reviewing**: Following the practice of major conferences in the field, and to manage the volume of submissions, BMVC 2026 relies on a community reviewing model. By submitting a paper, authors acknowledge a commitment to review a proportional number of papers for the conference. Failure to engage adequately with the reviewing process may be grounds for rejection. No extensions will be granted to the submission deadline.
...
For queries related to the paper submission and programme, please contact the Programme Chairs at: 
[bmvc2026pc@gmail.com](mailto:bmvc2026pc@gmail.com)
